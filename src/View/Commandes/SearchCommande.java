...
import BDD.Base;
import Controller.Commandes.ModifSupprCommandes.ActionList;
import Controller.Commandes.ModifSupprCommandes.ActionValiderVerif;
...
public class SearchCommande extends JDialog{
	...
	public SearchCommande(Base base, JFrame frame, String fonction){
	    ...
	    bouton.addActionListener(new ActionValiderVerif(this, base, numCom, numComClient, frame, fonction));
